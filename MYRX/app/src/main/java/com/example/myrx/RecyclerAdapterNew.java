...
public class RecyclerAdapterNew extends RecyclerView.Adapter<RecyclerAdapterNew.MyViewHolder>{
    private static final String TAG = "RecyclerAdapter";

    private List<Post> posts = new ArrayList<>();
    private OnPostClickListener onPostClickListener;

    public RecyclerAdapterNew(OnPostClickListener onPostClickListener) {
